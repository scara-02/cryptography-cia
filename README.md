...
is this correct
    -2.what hash functions i can use
    -3.can you explain sha256 algorithm
    -4.can i implement any easy hash function
    -5.can you give the algorithm or psedo code for the above hash function i.e polynomial rolling hash
